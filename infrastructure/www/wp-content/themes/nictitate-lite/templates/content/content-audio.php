<?php 
    $audio = nictitate_lite_content_get_audio( get_the_content() ); 
    $nictitate_lite_current_layout = nictitate_lite_get_template_setting();
?>
<li id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <article class="entry-item audio-post <?php echo esc_attr( $nictitate_lite_current_layout['layout_id'] == 'blog-2-right-sidebar' ? 'clearfix' : '' ); ?>">
        <?php if ( ! empty( $audio ) ) : ?> 
